...
// Get unique target stages from all ships (blank at bottom)
...
// Get unique comments from all ships (blank at bottom)
...
// Filtered ships based on all filters
const filteredShips = computed(() => {
  let result = props.ships
...
// Watch filteredShips and emit changes to parent
watch(filteredShips, (newFiltered) => {
